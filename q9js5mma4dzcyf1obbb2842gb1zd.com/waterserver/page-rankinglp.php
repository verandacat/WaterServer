...
?>
		...
		<?php endif; ?>
			...
			<div class="server_caption">
				...
				if($post->ID == 60){
					$url = "https://https://xn--q9js5mma4dzcyg1obbb2842gb1zd.com//link?link_id=60";
				}
				 ?>
				<a target="_blank" href="<?php echo $url; ?>" rel="external nofollow" class="prrrr">
					...
					<?php }else if($post->ID == 60){ ?>
                                                <?php if(0){ ?>
						<a href="https://https://xn--q9js5mma4dzcyg1obbb2842gb1zd.com/new.php?id=37" target="_blank" >
				...
				<?php endif ?>
				<div class="floatright <?php if($post->ID == 334 || $post->ID == 57 || $post->ID == 496 || $post->ID == 59){ ?>isim <?php } ?>"><strong>
					<?php if($post->ID == 57){ ?>
					...
					<?php if($post->ID == 59){ ?>
						...
						<a href="https://xn--q9js5mma4dzcyg1obbb2842gb1zd.com/new.php?id=41" target="_blank" class="prrrr">
						  <img class="no1 vert" src="<?php bloginfo('template_directory'); ?>/img/frecious_norikae.png" alt=""></a>
							<img class="no1 vert" src="<?php bloginfo('template_directory'); ?>/img/logo.jpg" alt="">
						</div>
					<?php } ?>
					<?php if($post->ID == 334){ ?>
						<div class="no1imgwrap">
