...
?>
    ...
    <h1><img src="<?php bloginfo('template_directory'); ?>/img/search/img-visual-result.jpg"
            alt="あなたにおすすめのウォーターサーバー業者はこちら！" width="960" height="164" /></h1>
            ...
            <table>
                ...
                <tr>
                    <th rowspan="2">
                        ...
                        <a href="<?php bloginfo('url'); ?>/link?link_id=<?php echo $pickup_id;?>&type=pickup"
                            rel="external nofollow" class="prrrr">
                            <img src="<?php echo get_field('banner',$pickup_id); ?>"
                                alt="<?php echo get_post_meta($pickup_id,"product_name", true); ?>" width="125"
                                height="125" />
                        </a>
                    ...
                    <td><?php echo get_post_meta($pickup_id,"server_cost", true);?>
					</td>
...
?>
                <tr>
                    <th rowspan="2">
                        ...
                        <?php if($post['id'] == 59){ ?>
                        <a href="<?php bloginfo('url'); ?>/link?link_id=<?php echo $post['id'];?>" target="_blank"
                            class="prrrr"><img class="vert height125" style="display:inline-block"
                                src="https://xn--u9jj6mma4dzcyg1obbb6302kt3ybp8q4p7h.jp/wp-content/uploads/2020/09/frecious_1f_dewo_400_400.jpg"
                                alt=""></a>
                        <a href="<?php bloginfo('url'); ?>/link?link_id=<?php echo $post['id'];?>"
                    ...
                    <td><?php echo $post["shipping_cost"];?>
