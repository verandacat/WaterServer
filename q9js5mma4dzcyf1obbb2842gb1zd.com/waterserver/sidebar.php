...
width="230" height="234" /> -->
    ...
    <a href="<?php bloginfo('url'); ?>/shindan" id="shindan_banner">
...
?>
    ...
    <a href="https://xn--q9js5mma4dzcyg1obbb2842gb1zd.com/new.php?id=40" class="prrrr" id="banner_ranking_sub"
        target="_blank">
    ...
    <a href="<?php bloginfo('url'); ?>/premium-water/" id="banner_ranking_sub" target="_blank"><img
            src="<?php bloginfo('template_directory'); ?>/img/waterserver-b_pc.png" alt="プレミアムウォーターを徹底検証！" width="230"
            height="auto" /></a>


    <a href="<?php bloginfo('url'); ?>/contact.php/" id="banner_ranking_sub"><img
            src="<?php bloginfo('template_directory'); ?>/img/0808-water-bn.png" alt="お水に関して無料メール相談はこちら" width="230"
            height="auto" /></a>

    <?php if (!is_category('column')) { ?>
    <a href="<?php bloginfo('url'); ?>/category/column/" id="banner_ranking_sub"><img
            src="<?php bloginfo('template_directory'); ?>/img/column-bn.png" alt="`ウォーターサーバーコラムはこちら`" width="230"
            height="auto" /></a>
    <?php } else { ?>
    <?php } ?>
