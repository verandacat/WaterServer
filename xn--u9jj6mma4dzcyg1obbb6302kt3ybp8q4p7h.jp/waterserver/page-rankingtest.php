...
", "description" =>"富士山の地下より採水したお水を山道の湧き水のような美味しさを保つために希少な非加熱処理。ほのかに甘い後味が人気です。１パックが軽量なため、女性やお子さんでも楽に取り付け可能。"),
	...
	// 	$pst = "private";
	// }
	$args =  array( 'post_type' => 'waterserver','orderby' => 'meta_value_num', 'meta_key' => 'recommend_order_new', 'order' => 'ASC', 'posts_per_page' => -1, 'meta_compare' => '!=');
                        ...
                        <div class="floatright <?php if($post->ID == 57 || $post->ID == 59){ ?>isim<?php } ?>">
                            ...
                            <strong>
                                ...
                                <div class="no1imgwrap">
                                    <a target="_blank" href="<?php echo $url; ?>" rel="external nofollow"
                                        ...
                                        <img class="no1 height125"
                                            src="<?php bloginfo('template_directory'); ?>/img/200629_120x120.png" alt=""
                                            style="width: 125px">
                                    </a>
                                    <img class="no1 height125"
                                        src="<?php bloginfo('template_directory'); ?>/img/no.1_logo_jmro_moji_120.png" alt=""
                                        style="width: 125px">
                                ...
                                <div class="no1imgwrap">
                                    ...
                                    <a href="https://xn--u9jj6mma4dzcyg1obbb6302kt3ybp8q4p7h.jp/new.php?id=39"
                                        target="_blank" class="prrrr"><img class="vert height125"
                                    ...
                                    <a href="<?php echo $url; ?>&type=free" target="_blank" class="prrrr"><img
                                            ...
                                            src="<?php bloginfo('template_directory'); ?>/img/frecious_norikae.png"
                                            style="display:inline-block"></a>
                                ...
                                <div class="no1imgwrap newwrap">
                                    <a target="_blank" href="<?php echo $url; ?>" rel="external nofollow"
                                        class="prrrr deco-none">
                                        <img class="no1 height125"
                                            src="<?php bloginfo('template_directory'); ?>/img/aquaclara_125_125.gif" alt=""
                                            style="width: 125px">
                                    </a>
                                    <a href="https://xn--u9jj6mma4dzcyg1obbb6302kt3ybp8q4p7h.jp/new.php?id=31"
                                        target="_blank" class="prrrr">
                                        <img class="no1 height125"
                                            src="<?php bloginfo('template_directory'); ?>/img/kosodate.gif" alt=""
                                            style="width: 125px">
                                    </a>
                                    <a target="_blank" href="<?php echo $url; ?>" rel="external nofollow"
                                        class="prrrr deco-none">
 ...
 -->
                    ...
                    <table>
                        ...
                        <tr class="last_tr">
                            ...
                            <td colspan="3">
                                <span><?php echo $shipping_areas[get_field("shipping_area",$post->ID)];?></span></td>
                        </tr>
                    </table>
