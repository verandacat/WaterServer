...
<?php if(!is_mobile()){ ?>
<a href="<?php bloginfo('url'); ?>/ranking/" id="banner_ranking"><img src="<?php bloginfo('template_directory'); ?>/img/top/bnr-ranking_off.jpg" alt="2014年版　本気でオススメできる優良ウォーターサーバー人気ランキング" width="700" height="99" /></a>

<?php }else{ ?>
<a href="/ranking/" class="top_rank_banner">
<img src="<?php bloginfo('template_directory'); ?>/spimg/sprankbanner.png" alt="2014年版　本気でオススメできる優良ウォーターサーバー人気ランキング" class="sprankbanner" />
</a>
...
<div id="modal" class="modal">
  <div class="modal-content">
    <div class="modal-body">
      ...
      <ul>
      <li class="pc"><a href="<?php bloginfo('url'); ?>/ranking/?select=baby" class="close_modal"><img src="<?php bloginfo('template_directory'); ?>/img/ch_01.png"></a></li>
      <li class="pc"><a href="<?php bloginfo('url'); ?>/ranking/?select=kids" class="close_modal"><img src="<?php bloginfo('template_directory'); ?>/img/ch_02.png"></a></li>
      <li class="pc"><a href="<?php bloginfo('url'); ?>/ranking/?select=not" class="close_modal"><img src="<?php bloginfo('template_directory'); ?>/img/ch_03.png"></a></li>
      <li class="sp"><a href="<?php bloginfo('url'); ?>/ranking/?select=baby" class="close_modal"><img src="<?php bloginfo('template_directory'); ?>/img/ch_01_sp.png"></a></li>
      <li class="sp"><a href="<?php bloginfo('url'); ?>/ranking/?select=kids" class="close_modal"><img src="<?php bloginfo('template_directory'); ?>/img/ch_02_sp.png"></a></li>
      <li class="sp"><a href="<?php bloginfo('url'); ?>/ranking/?select=not" class="close_modal"><img src="<?php bloginfo('template_directory'); ?>/img/ch_03_sp.png"></a></li>
      </ul>
    </div>
  </div>
</div>
...
.modal { position:fixed; display:none; z-index:9999; top:40%; left:40%; width:700px; margin:-120px 0 0 -220px; padding:20px; text-align:center;;
...
.modal { position:fixed; display:none; z-index:9999; top:4%; left:5%; width:90%; padding:20px; text-align:center;
-webkit-border-radius:5px;
-moz-border-radius:5px;
border-radius:5px;
}
