	...
	while ( $loop->have_posts() ) : $loop->the_post();
		...
		<?php endif; ?>
			...
			<div class="server_caption">
				<?php if($attachment_obj != ""){ ?>
					<?php
						...
						/*if($post->ID == 60){$url = "http://ad.isaf.jp/bin/w.x?p=1794&b=544&o=530&s=535";}*/ ?>
					...
					<?php } ?>
						...
						text-decoration:none!important;
							...
							<a target="_blank" href="<?php echo $url; ?>" rel="external nofollow" class="prrrr deco-none">
							<img class="no1 height125" src="<?php bloginfo('template_directory'); ?>/img/bn_02_125×125.jpg" alt="" style="width: 125px">
							</a>
							<img class="no1 height125" src="<?php bloginfo('template_directory'); ?>/img/customerno1.png" alt="" style="width: 100px">
							<img class="no1" src="<?php bloginfo('template_directory'); ?>/img/g_type2018_c.jpg" alt="" style="width: 90px">
							<img class="no1" src="<?php bloginfo('template_directory'); ?>/img/tamahiyo.png" alt="" style="width: 125px">
						...
						<div class="no1imgwrap">
						  ...
						  <a href="<?php echo $url; ?>&type=free" target="_blank" class="prrrr">
						  <img class="vert height125" src="<?php bloginfo('template_directory'); ?>/img/frecious_norikae.png" style="display:inline-block"></a>
						...
						<div class="no1imgwrap newwrap">
							<a target="_blank" href="<?php echo $url; ?>" rel="external nofollow" class="prrrr deco-none">
							<img class="no1 height125" src="<?php bloginfo('template_directory'); ?>/img/aqua125_202005.gif" alt="" style="width: 125px">
							</a>
							<a href="https://xn--u9jj6mma4dzcyg1obbb6302kt3ybp8q4p7h.jp/new.php?id=31" target="_blank" class="prrrr">

							<img class="no1 height125" src="<?php bloginfo('template_directory'); ?>/img/kosodate.gif" alt="" style="width: 125px">
							</a>
							<a target="_blank" href="<?php echo $url; ?>" rel="external nofollow" class="prrrr deco-none">
							<img class="no1 height125" src="<?php bloginfo('template_directory'); ?>/img/fab.gif" alt="" style="width: 125px">
							<img class="no1 height125" src="<?php bloginfo('template_directory'); ?>/img/with.gif" alt="" style="width: 125px">
							</a>
						</div>
						<?php } ?>
						<?php if($post->ID == 334){ ?>
							...
							<div class="no1imgwrap">
							<a target="_blank" href="https://xn--u9jj6mma4dzcyg1obbb6302kt3ybp8q4p7h.jp/link?link_id=334" rel="external nofollow" class="prrrr deco-none">
								<img class="no1 width125 m20" src="<?php bloginfo('template_directory'); ?>/img/creclafit2_300.png" alt="">
							</a>
							<img class="no1 m20 heightauto" src="<?php bloginfo('template_directory'); ?>/img/no1_small.jpg" alt="">
							<img class="no1 m20 heightauto" src="<?php bloginfo('template_directory'); ?>/img/2020_small.jpg" alt="">
							<!-- <div class="no1imgwrap">
          ...
          <p><?php echo $item_description; ?></p>
				...
				<table>
					<tr>
						<th><span>お水の価格（1本）</span></th><td><span>
						<?php 
				...
				<img src="<?php bloginfo('template_directory'); ?>/img/common/btn-official-site_off.jpg" alt="公式サイトへ" width="310" height="60" /></a>
				<?php } ?>
			<?php } else { ?>
			...
			<div class="rank_caption">
				...
				<?php endif; ?>
					<?php if($post->ID == 57){ ?>
						<a class="gd" target="_blank" href="<?php bloginfo('url'); ?>/link?link_id=<?php echo $post->ID; ?>" rel="external nofollow" class="prrrr">
							<img src="<?php bloginfo('template_directory'); ?>/img/gd.png" alt="">
						</a>
					<?php }else if($post->ID == 496){ ?>
						<a class="gd" target="_blank" href="<?php bloginfo('url'); ?>/link?link_id=<?php echo $post->ID; ?>" rel="external nofollow" class="prrrr">
					...
					<?php }else if($post->ID == 59){ ?>
					  <p style="padding:5px 0 0"><a href="https://xn--u9jj6mma4dzcyg1obbb6302kt3ybp8q4p7h.jp/new.php?id=39" target="_blank" class="prrrr"><img class="no1 vert" src="<?php bloginfo('template_directory'); ?>/img/fre20191030.jpg" alt=""></a></p>
					<?php }else if($post->ID == 334){ ?>
							<!-- <div class="hidari"><img  class="no1 sp spimg" src="<?php bloginfo('template_directory'); ?>/img/cokyaku_s.jpg" alt=""></div> -->
					<?php }else if($post->ID == 60){ ?>
						<a target="_blank" href="<?php bloginfo('url'); ?>/link?link_id=<?php echo $post->ID; ?>" rel="external nofollow" class="prrrr">
						<img src="<?php bloginfo('template_directory'); ?>/img/fab.gif" alt="" style="margin-top:5px;">
						</a>
						<br><img src="<?php bloginfo('template_directory'); ?>/img/g_type2018_b.jpg" alt="">

                   <?php if(0){ ?>
						<a class="gd" target="_blank" href="http://ad.isaf.jp/bin/w.x?p=1794&b=544&o=530&s=535" rel="external nofollow">
							<img src="<?php bloginfo('template_directory'); ?>/img/akuaclara_akb20181129_125.jpg" alt="">
							        <?php } ?>
						</a>
					<?php } ?>
				...
				<div class="rankright"><strong>
					...
					<?php if($post->ID == 57){ ?>
						<div class="spimbox">
						<img class="no1 sp" src="<?php bloginfo('template_directory'); ?>/img/no1.png" alt="">
					</div>
					<?php } ?>
					<?php if($post->ID == 496){ ?>
						...
						<a target="_blank" href="<?php bloginfo('url'); ?>/link?link_id=<?php echo $post->ID; ?>" rel="external nofollow" class="prrrr">
						<img class="no1 sp no1_2" src="<?php bloginfo('template_directory'); ?>/img/bn_02_125×125.jpg" alt=""></a>
						<img class="no1 sp no1_2" src="<?php bloginfo('template_directory'); ?>/img/customerno1.png" alt="" style="margin-left: 3px!important; width: 65px!important;">
						<img class="no1 sp no1_2" src="<?php bloginfo('template_directory'); ?>/img/g_type2018_c.jpg" alt="" style="margin-left: 3px!important; width: 60px!important;">
					...
					<?php if($post->ID == 59){ ?>
						...
						<div class="spimbox w100">
						<a target="_blank" href="<?php bloginfo('url'); ?>/link?link_id=<?php echo $post->ID; ?>&type=mama" rel="external nofollow" class="prrrr deco-none">
							<img class="no1 vert sp" src="<?php the_field('banner2'); ?>" alt="" style="margin-right:10px!important">
						</a>
						<a href="<?php bloginfo('url'); ?>/link?link_id=<?php echo $post->ID; ?>&type=free" target="_blank" class="prrrr deco-none">
						<img class="no1 vert sp" src="<?php bloginfo('template_directory'); ?>/img/frecious_norikae.png" alt="" style="margin-right:5px!important">
						</a>
						<img class="no1 vert sp" src="<?php bloginfo('template_directory'); ?>/img/logo.jpg" alt="" style="margin:0 10px 10px 0 !important; width:55px!important">
						</div>
					<?php } ?>
					<?php if($post->ID == 60){ ?>
						<style>
						...
						<div class="spimbox w100">
						<a target="_blank" href="<?php bloginfo('url'); ?>/link?link_id=<?php echo $post->ID; ?>" rel="external nofollow" class="prrrr">
						<img class="no1 sp no1_2" src="<?php bloginfo('template_directory'); ?>/img/aqua125_202005.gif" alt="">
						</a>
						<a href="https://xn--u9jj6mma4dzcyg1obbb6302kt3ybp8q4p7h.jp/new.php?id=31" target="_blank" class="prrrr">
						<img class="no1 sp no1_2" src="<?php bloginfo('template_directory'); ?>/img/kosodate.gif" alt="" style="margin-left: 5px;">
						</a>
						<a target="_blank" href="<?php bloginfo('url'); ?>/link?link_id=<?php echo $post->ID; ?>" rel="external nofollow" class="prrrr">
						<img class="no1 sp no1_2" src="<?php bloginfo('template_directory'); ?>/img/with.gif" alt="" style="margin-left: 5px;">
						</a>
						</div>
					<?php } ?>
					<?php if($post->ID == 334){ ?>
						...
						<img class="no1 sp" src="<?php bloginfo('template_directory'); ?>/img/no1_small.jpg" alt="">
					
					   <img class="no1 sp" src="<?php bloginfo('template_directory'); ?>/img/2020_small.jpg" alt="">
