...
<div id="main_contents">
    ...
    <?php endif; ?>
    <div id="footmark"><a href="<?php bloginfo('url'); ?>/">トップページ</a><span>&nbsp;&gt;&nbsp;<?php the_title(); ?></span>
    </div>
    <dl class="ranking">
        <dt>
...
?>
            ...
            <div class="ranking_result">
                ...
                <table>
                    ...
                    <tr class="last_tr">
                        ...
                        <td colspan="3"><span><?php echo $shipping_areas[get_field("shipping_area",$post->ID)];?></span>
                        </td>
                    </tr>
                </table>
        ...
        <div id="footmark"><a href="<?php bloginfo('url'); ?>/">トップページ</a><span>&nbsp;&gt;&nbsp;<?php echo $t; ?></span>
        </div>
                    ...
                    <div class="s_items_header">
                        <div class="upper_left">
                            <a target="_blank" href="<?php bloginfo('url'); ?>/link?link_id=<?php echo $post->ID;?>"
                                class="prrrr"><img src="<?php echo $attachment_obj; ?>"
                                    alt="<?php echo get_post_meta($post->ID,"product_name", true); ?>" width="125"
                                    height="125" />
                            </a>
                        </div>
                        <h3 class="list_item_title">
                            <a target="_blank" href="<?php bloginfo('url'); ?>/link?link_id=<?php echo $post->ID;?>"
                                class="prrrr"><?php echo $t; ?></a>
                        </h3>
                    </div>
                    <div class="s_items_body">
                        ...
                        <div class="tokoshiki">
                            ...
                            <a href="<?php bloginfo('url'); ?>/link?link_id=<?php echo $post->ID;?>"
                                rel="external nofollow" class="official_site prrrr">
                                <span>公式サイトはこちら</span>
                            </a>
                        </div>
                    </div>
