...
<title>ウォーターサーバー人気なび <?php if (is_front_page()) : echo "| 探し求めていた水サーバーが見つかる！!"; elseif (is_single() || is_page()) : echo "| " ; the_title(); endif; ?></title>
...
<h1><a href="https://ウォーターサーバー人気なび.com/index.html"><img src="<?php bloginfo('template_directory'); ?>/img/common/img-header-logo.jpg" alt="ウォーターサーバーガイド　WATER&nbsp;SERVER&nbsp;GUIDE" width="422" height="73" /></a></h1>
...
<?php }else{ ?>
<h1>
	<a href="https://ウォーターサーバー人気なび.com/index.html">
		<div id="titlebar">
			ウォーターサーバー人気なび
		</div>
	</a>
