...
<dl class="result pickup">
	...
	<dd>
		...
		<table>
			...
			<tr>
				<th rowspan="2">
					<a href="<?php bloginfo('url'); ?>/link?link_id=<?php echo $pickup_id;?>&type=pickup" rel="external nofollow" class="prrrr">
						<img src="<?php echo get_field('banner',$pickup_id); ?>" alt="<?php echo get_post_meta($pickup_id,"product_name", true); ?>" width="125" height="125" />
					</a>
					<a href="<?php bloginfo('url'); ?>/link?link_id=<?php echo $pickup_id;?>&type=pickup" rel="external nofollow" class="prrrr"><?php echo get_post_meta($pickup_id,"product_name", true); ?></a>
				</th>
			...
			<tr>
				...
				<td colspan="3" class="site_link">
					<a href="<?php bloginfo('url'); ?>/link?link_id=<?php echo $pickup_id; ?>&type=pickup" rel="external nofollow" class="prrrr"><img src="<?php bloginfo('template_directory'); ?>/img/common/btn-official-site_off.jpg" alt="公式サイトはこちら" width="310" height="60" /></a>
				</td>
			</tr>
		</table>
...
?>
			<tr>
				<th rowspan="2">
					<a href="<?php bloginfo('url'); ?>/link?link_id=<?php echo $post['id'];?>" rel="external nofollow" class="prrrr">
						<img src="<?php echo $post['banner']; ?>" alt="<?php echo $post["product_name"]; ?>" width="125" height="125" />
					</a>
					<a href="<?php bloginfo('url'); ?>/link?link_id=<?php echo $post['id'];?>" rel="external nofollow" class="prrrr"><?php echo $post["product_name"]; ?></a>
				</th>
			...
			<tr>
				...
				<td colspan="3" class="site_link">
					<a href="<?php bloginfo('url'); ?>/link?link_id=<?php echo $post['id'];?>" rel="external nofollow" class="prrrr"><img src="<?php bloginfo('template_directory'); ?>/img/common/btn-official-site_off.jpg" alt="公式サイトはこちら" width="310" height="60" /></a>
				</td>
			</tr>
<?php
}
