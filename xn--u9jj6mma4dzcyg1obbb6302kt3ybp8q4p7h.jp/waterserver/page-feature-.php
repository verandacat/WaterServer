		...
		<?php endif; ?>
			...
			<div class="server_caption">
				<?php if($attachment_obj != ""){ ?>
					...
					<div class="floatright <?php if($post->ID == 57 || $post->ID == 496 || $post->ID == 59 || $post->ID == 334){ ?>isim <?php } ?>"><strong>
						...
						<?php if($post->ID == 59){ ?>
							<div class="no1imgwrap">
							  <img  class="no1 vert" src="<?php bloginfo('template_directory'); ?>/img/gd2_slim.png" alt="">
								<img  class="no1 vert" src="<?php bloginfo('template_directory'); ?>/img/logo_kids.jpg" alt="">
							</div>
						<?php } ?>
 ...
 -->
			...
			<div class="rank_caption">
				...
				<?php endif; ?>
					...
					<?php }else if($post->ID == 59){ ?>
						<a class="gd" target="_blank" href="<?php bloginfo('url'); ?>/link?link_id=<?php echo $post->ID; ?>?type=mama" rel="external nofollow" class="prrrr">
							<img src="<?php the_field('banner2'); ?>" alt="">
						</a>
					<?php }else if($post->ID == 334){ ?>
				...
				<div class="rankright"><strong>
					...
					<?php if($post->ID == 59){ ?>
						<div class="spimbox2">
					  <img class="no1 sp vert" src="<?php bloginfo('template_directory'); ?>/img/gd2_slim.png" alt="">
						<img class="no1 sp vert" src="<?php bloginfo('template_directory'); ?>/img/logo_kids.jpg" alt="">
					</div>
					<?php } ?>
					<?php if($post->ID == 334){ ?>
						<div class="spimbox">
