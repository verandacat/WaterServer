                ...
                <div class="<?php if(!is_mobile()){ ?>ranking_result<?php }else{ ?>ranking_resultsp<?php } ?>"
                    ...
                    <h2 class="rank_item_title">
                        ...
                        <a href="<?php bloginfo('url'); ?>/link?link_id=<?php echo $post->ID; ?>"
                            rel="external nofollow"
                            class="prrrr font-20"><?php echo get_post_meta($post->ID, "product_name", true); ?></a>
                        <?php else : ?>
                        <a href="<?php bloginfo('url'); ?>/link?link_id=<?php echo $post->ID; ?>"
                            rel="external nofollow"
                            class="prrrr"><?php echo get_post_meta($post->ID, "product_name", true); ?></a>
                    ...
                    <div class="s_items_table">
                        ...
                        <table>
                            ...
                            <tr class="last_tr">
                                <th>配送地域</th>
                                <td colspan="3"><?php echo $shipping_areas[get_field("shipping_area", $post->ID)]; ?>
                                </td>
                            </tr>
                        </table>
                    ...
                    <p class="rank_descript"><?php echo $item_description; ?></p>
                    <?php if($post->ID == 496) : ?>
