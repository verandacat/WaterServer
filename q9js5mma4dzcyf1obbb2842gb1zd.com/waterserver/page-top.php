...
<div id="main_contents">
    ...
    <a href="/ranking/" class="top_rank_banner">
        <img src="<?php bloginfo('template_directory'); ?>/spimg/sprankbanner.png"
            alt="2014年版　本気でオススメできる優良ウォーターサーバー人気ランキング" class="sprankbanner" />
    </a>
...
<div id="modal" class="modal">
    <div class="modal-content">
        <div class="modal-body">
            ...
            <ul>
                <li class="pc"><a href="<?php bloginfo('url'); ?>/ranking/?select=baby" class="close_modal"><img
                            src="<?php bloginfo('template_directory'); ?>/img/ch_01.png"></a></li>
                <li class="pc"><a href="<?php bloginfo('url'); ?>/ranking/?select=kids" class="close_modal"><img
                            src="<?php bloginfo('template_directory'); ?>/img/ch_02.png"></a></li>
                <li class="pc"><a href="<?php bloginfo('url'); ?>/ranking/?select=not" class="close_modal"><img
                            src="<?php bloginfo('template_directory'); ?>/img/ch_03.png"></a></li>
                <li class="sp"><a href="<?php bloginfo('url'); ?>/ranking/?select=baby" class="close_modal"><img
                            src="<?php bloginfo('template_directory'); ?>/img/ch_01_sp.png"></a></li>
                <li class="sp"><a href="<?php bloginfo('url'); ?>/ranking/?select=kids" class="close_modal"><img
                            src="<?php bloginfo('template_directory'); ?>/img/ch_02_sp.png"></a></li>
                <li class="sp"><a href="<?php bloginfo('url'); ?>/ranking/?select=not" class="close_modal"><img
