...
<dl id="side_menu">
	...
	<dd>
		<ul>
			...
			<li><a href="<?php bloginfo('url'); ?>/deskserver"><img src="<?php bloginfo('template_directory'); ?>/img/common/btn-sub-navi07_<?php echo $conv_img; ?>.gif" alt="卓上型サーバー" width="230" height="50" /></a></li>

			<li><a href="<?php bloginfo('url'); ?>/purifier"><img src="<?php bloginfo('template_directory'); ?>/img/common/btn-sub-navi08_<?php echo $conv_img; ?>.gif" alt="水道浄水型サーバー" width="230" height="50" /></a></li>
...
<a href="<?php bloginfo('url'); ?>/premium-water/" id="banner_ranking_sub" target="_blank"><img src="<?php bloginfo('template_directory'); ?>/img/waterserver-b_pc.png" alt="2014年版人気ランキング　今年No.1のおすすめウォーターサーバーは？　ランキング詳細はこちら" width="230" height="auto" /></a>

<a href="https://xn--u9jj6mma4dzcyg1obbb6302kt3ybp8q4p7h.jp/link?link_id=60" id="banner_ranking_sub" class="prrrr" target="_blank"><img src="<?php bloginfo('template_directory'); ?>/img/moraeru.jpg" alt="アクアクララ AQUA FAB" width="230" height="auto" /></a>


<a href="https://xn--u9jj6mma4dzcyg1obbb6302kt3ybp8q4p7h.jp/new.php?id=40" target="_blank" id="banner_ranking_sub" class="prrrr" target="_blank"><img src="<?php bloginfo('template_directory'); ?>/img/frecious_slatcafe_300_250_20200522.jpg" alt="" width="230" height="auto" /></a>
<?php
...
<?php include(TEMPLATEPATH .'/inc/spside-test.php'); ?>
<?php } ?>